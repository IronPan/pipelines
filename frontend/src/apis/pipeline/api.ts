 ...
 *
 * @export
 * @interface ApiCodeSource
 */
export interface ApiCodeSource {
    /**
     *
     * @type {string}
     * @memberof ApiCodeSource
     */
    repo_name?: string;
    /**
     *
...
export interface ApiPipeline {
    ...
    /**
     * Input. This is only for backward compatibility purpose and will be removed in the future. User can create a new Pipeline with a new Version by specifying the URL.
     * @type {ApiUrl}
     * @memberof ApiPipeline
     */
    url?: ApiUrl;
...
export interface ApiPipelineVersion {
     ...
     * @memberof ApiPipelineVersion
     */
    code_source?: ApiCodeSource;
    /**
     * Input. The URL to the source of the pipeline. This is required when creating the pipeine through CreatePipeline API.
     * @type {ApiUrl}
     * @memberof ApiPipelineVersion
     */
    url?: ApiUrl;
...
export const PipelineServiceApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createPipelineVersion(pipeline_id: string, body: ApiPipelineVersion, options: any = {}): FetchArgs {
            // verify required parameter 'pipeline_id' is not null or undefined
            if (pipeline_id === null || pipeline_id === undefined) {
                throw new RequiredError('pipeline_id','Required parameter pipeline_id was null or undefined when calling createPipelineVersion.');
            }
            // verify required parameter 'body' is not null or undefined
            if (body === null || body === undefined) {
                throw new RequiredError('body','Required parameter body was null or undefined when calling createPipelineVersion.');
            }
            const localVarPath = `/apis/v1beta1/pipelines/{pipeline_id}/versions`
         ...
         * @throws {RequiredError}
         */
        getPipelineVersion(pipeline_id: string, version_id: string, options: any = {}): FetchArgs {
            // verify required parameter 'pipeline_id' is not null or undefined
            if (pipeline_id === null || pipeline_id === undefined) {
                throw new RequiredError('pipeline_id','Required parameter pipeline_id was null or undefined when calling getPipelineVersion.');
            }
            ...
            const localVarPath = `/apis/v1beta1/pipelines/{pipeline_id}/versions/{version_id}`
                .replace(`{${"pipeline_id"}}`, encodeURIComponent(String(pipeline_id)))
         ...
         * @throws {RequiredError}
         */
        getPipelineVersionTemplate(pipeline_id: string, version_id: string, options: any = {}): FetchArgs {
            // verify required parameter 'pipeline_id' is not null or undefined
            if (pipeline_id === null || pipeline_id === undefined) {
                throw new RequiredError('pipeline_id','Required parameter pipeline_id was null or undefined when calling getPipelineVersionTemplate.');
            }
            // verify required parameter 'version_id' is not null or undefined
            if (version_id === null || version_id === undefined) {
            ...
            const localVarPath = `/apis/v1beta1/pipelines/{pipeline_id}/versions/{version_id}/templates`
                .replace(`{${"pipeline_id"}}`, encodeURIComponent(String(pipeline_id)))
                .replace(`{${"version_id"}}`, encodeURIComponent(String(version_id)));
            const localVarUrlObj = url.parse(localVarPath, true);
            const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
         ...
         * @throws {RequiredError}
         */
        listPipelineVersions(pipeline_id: string, options: any = {}): FetchArgs {
            // verify required parameter 'pipeline_id' is not null or undefined
            if (pipeline_id === null || pipeline_id === undefined) {
                throw new RequiredError('pipeline_id','Required parameter pipeline_id was null or undefined when calling listPipelineVersions.');
            }
            const localVarPath = `/apis/v1beta1/pipelines/{pipeline_id}/versions`
                .replace(`{${"pipeline_id"}}`, encodeURIComponent(String(pipeline_id)));
            const localVarUrlObj = url.parse(localVarPath, true);
...
export const PipelineServiceApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        createPipelineVersion(pipeline_id: string, body: ApiPipelineVersion, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ApiPipelineVersion> {
            const localVarFetchArgs = PipelineServiceApiFetchParamCreator(configuration).createPipelineVersion(pipeline_id, body, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        getPipelineVersion(pipeline_id: string, version_id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ApiPipelineVersion> {
            const localVarFetchArgs = PipelineServiceApiFetchParamCreator(configuration).getPipelineVersion(pipeline_id, version_id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        getPipelineVersionTemplate(pipeline_id: string, version_id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ApiGetTemplateResponse> {
            const localVarFetchArgs = PipelineServiceApiFetchParamCreator(configuration).getPipelineVersionTemplate(pipeline_id, version_id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
         ...
         * @throws {RequiredError}
         */
        listPipelineVersions(pipeline_id: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ApiListPipelineVersionsResponse> {
            const localVarFetchArgs = PipelineServiceApiFetchParamCreator(configuration).listPipelineVersions(pipeline_id, options);
            return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
                return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then((response) => {
                    if (response.status >= 200 && response.status < 300) {
                        return response.json();
...
export const PipelineServiceApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        createPipelineVersion(pipeline_id: string, body: ApiPipelineVersion, options?: any) {
            return PipelineServiceApiFp(configuration).createPipelineVersion(pipeline_id, body, options)(fetch, basePath);
        },
        /**
         *
         * @param {string} id
         ...
         * @throws {RequiredError}
         */
        getPipelineVersion(pipeline_id: string, version_id: string, options?: any) {
            return PipelineServiceApiFp(configuration).getPipelineVersion(pipeline_id, version_id, options)(fetch, basePath);
        },
        /**
         *
         * @param {string} pipeline_id
         ...
         * @throws {RequiredError}
         */
        getPipelineVersionTemplate(pipeline_id: string, version_id: string, options?: any) {
            return PipelineServiceApiFp(configuration).getPipelineVersionTemplate(pipeline_id, version_id, options)(fetch, basePath);
        },
        /**
         *
         * @summary GetTemplate will get the default template for a given pipeline
         ...
         * @throws {RequiredError}
         */
        listPipelineVersions(pipeline_id: string, options?: any) {
            return PipelineServiceApiFp(configuration).listPipelineVersions(pipeline_id, options)(fetch, basePath);
        },
        /**
         *
         * @param {string} [page_token]
...
export class PipelineServiceApi extends BaseAPI {
     ...
     * @memberof PipelineServiceApi
     */
    public createPipelineVersion(pipeline_id: string, body: ApiPipelineVersion, options?: any) {
        return PipelineServiceApiFp(this.configuration).createPipelineVersion(pipeline_id, body, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof PipelineServiceApi
     */
    public getPipelineVersion(pipeline_id: string, version_id: string, options?: any) {
        return PipelineServiceApiFp(this.configuration).getPipelineVersion(pipeline_id, version_id, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof PipelineServiceApi
     */
    public getPipelineVersionTemplate(pipeline_id: string, version_id: string, options?: any) {
        return PipelineServiceApiFp(this.configuration).getPipelineVersionTemplate(pipeline_id, version_id, options)(this.fetch, this.basePath);
    }
     ...
     * @memberof PipelineServiceApi
     */
    public listPipelineVersions(pipeline_id: string, options?: any) {
        return PipelineServiceApiFp(this.configuration).listPipelineVersions(pipeline_id, options)(this.fetch, this.basePath);
    }
