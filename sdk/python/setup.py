...
REQUIRES = [
    ...
    'cloudpickle',
    'kfp-server-api >= 0.1.100, < 0.1.101', #Update the upper version whenever a new version of the kfp-server-api package is released. Update the lower version when there is a breaking change in kfp-server-api.
