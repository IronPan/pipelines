...
type CreateVersionParams struct {
	...
	/*Body*/
	Body *pipeline_model.APIVersion
	/*PipelineID*/
	PipelineID string
...
func (o *CreateVersionParams) WithBody(body *pipeline_model.APIVersion) *CreateVersionParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create version params
func (o *CreateVersionParams) SetBody(body *pipeline_model.APIVersion) {
	o.Body = body
}

// WithPipelineID adds the pipelineID to the create version params
func (o *CreateVersionParams) WithPipelineID(pipelineID string) *CreateVersionParams {
	o.SetPipelineID(pipelineID)
	return o
}

// SetPipelineID adds the pipelineId to the create version params
func (o *CreateVersionParams) SetPipelineID(pipelineID string) {
