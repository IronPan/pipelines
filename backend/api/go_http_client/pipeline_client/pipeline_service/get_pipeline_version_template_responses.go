...
func (o *GetPipelineVersionTemplateOK) Error() string {
	return fmt.Sprintf("[GET /apis/v1beta1/pipelines/{pipeline_id}/versions/{version_id}/templates][%d] getPipelineVersionTemplateOK  %+v", 200, o.Payload)
}
...
func (o *GetPipelineVersionTemplateDefault) Error() string {
	return fmt.Sprintf("[GET /apis/v1beta1/pipelines/{pipeline_id}/versions/{version_id}/templates][%d] GetPipelineVersionTemplate default  %+v", o._statusCode, o.Payload)
}
