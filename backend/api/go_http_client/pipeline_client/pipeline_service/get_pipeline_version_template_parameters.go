...
// WithPipelineID adds the pipelineID to the get pipeline version template params
func (o *GetPipelineVersionTemplateParams) WithPipelineID(pipelineID string) *GetPipelineVersionTemplateParams {
	o.SetPipelineID(pipelineID)
	return o
}

// SetPipelineID adds the pipelineId to the get pipeline version template params
func (o *GetPipelineVersionTemplateParams) SetPipelineID(pipelineID string) {
