...
func (o *GetVersionOK) Error() string {
	return fmt.Sprintf("[GET /apis/v1beta1/pipelines/{pipeline_id}/versions/{version_id}][%d] getVersionOK  %+v", 200, o.Payload)
}
...
GetVersionDefault get version default
*/
...
func (o *GetVersionDefault) Error() string {
	return fmt.Sprintf("[GET /apis/v1beta1/pipelines/{pipeline_id}/versions/{version_id}][%d] GetVersion default  %+v", o._statusCode, o.Payload)
}
